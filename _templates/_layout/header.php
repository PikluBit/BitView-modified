...
function openMenu(e) {
    if (document.getElementsByClassName('yt-uix-button-menu')[0].classList.contains("hid")) {
        if (e != undefined) {
            document.getElementsByClassName('yt-uix-button-menu')[0].classList.remove("hid");
        ...
        document.getElementsByClassName('yt-uix-button-menu')[0].classList.add("hid");
        document.getElementsByClassName('flip')[0].classList.remove("yt-uix-button-active");
    }
}
window.onclick = function(event) {
  if (!event.target.matches('.yt-uix-button-menu') && !event.target.matches('.yt-uix-button') && !event.target.matches('.yt-uix-button-arrow')  && !event.target.matches('.yt-uix-button-content')) {
    var dropdowns = document.getElementsByClassName("yt-uix-button-menu");
    var i;
...
<div id="page">
    ...
    <form autocomplete="off" class="search-form" action="/results" method="get" name="searchForm" class="search-form" id="masthead-search" onsubmit="if (document.getElementById('masthead-search-term').value != '') { document['searchForm'].submit(); }; return false;;return false;">
        ...
        <div onclick="" class="yt-uix-button-menu yt-uix-button-menu-text hid">    <table>
                <tbody><tr>
